/*
Importing csv file into athlete table with "NA" values as Null
*/
COPY athlete FROM '/Users/stephenandrewaigner/Downloads/archive (10)/athlete_events.csv' 
WITH DELIMITER ',' 
NULL AS 'NA'
CSV HEADER;
...
*/
SELECT DISTINCT sport AS "Sport", ROUND(AVG(age),1) AS "Average Age", ROUND(AVG(weight),1) AS "Average Weight", ROUND(AVG(height),1) AS "Average Height" 
FROM athlete
GROUP BY sport;
